...
%A1S method
lend = length(substring{1,1})-9-length(shortphase);
tabindexsubstring= substring{1,1}(1:lend); %works for all missionphases
newstring= '/Users/frejon/Documents/RosettaArchive/PDS_Archives/DATASETS/SECOND_DELIVERY_VERSIONS/A1S/';
newstring2= '/Users/frejon/Documents/RosettaArchive/PDS_Archives/DATASETS/SECOND_DELIVERY_VERSIONS/A2S/';

%
tabindex2=tabindex;

tabindex(:,1) = cellfun(@(x) strrep(x,tabindexsubstring,newstring),tabindex(:,1),'un',0);
tabindex2(:,1) = cellfun(@(x) strrep(x,tabindexsubstring,newstring2),tabindex2(:,1),'un',0);
...
fld={'t1' 'Iph0' 'Tph' 'asm_ni_v_indep' 'asm_ne_exp' 'ne_exp' 'asm_ne_linear' 'asm_ne_5eV' 'Vsg', 'ni_v_indep' 'ni_v_dep' 'ne_linear' 'ne_5eV' 'Te_linear' 'Te_exp'  'asm_Te_linear' 'asm_Te_exp' 'asm_v_ion' 'v_ion' 'v_aion' 'asm_Vsc_aion'  'Vsc_aion' 'asm_ni_aion' 'asm_v_aion' 'Vph_knee' 'ni_aion'};
...
%     
%     data1.ni_v_dep =   data1.ni_v_dep *2/7;
%     data2.ni_v_dep =   data2.ni_v_dep *2/7;
%     
% end
...
plot(data1.t1,data1.ne_exp,'b+',data1.t1,data1.ne_linear,'r',data1.t1,data1.ne_5eV,'g',data1.t1,data1.ni_v_indep,'ro',data1.t1,data1.ni_v_dep,'blacko',data1.t1,data1.asm_ni_v_indep,'black');
...
% 
% subplot(2,2,3)
% plot(data1.t1,data1.ni_v_indep,'blacko',data1.t1,data1.ni_v_dep,'ro',data1.t1,data1.asm_ni_v_indep,'bo',data1.t1,data1.ni_v_dep,'go')
% %plot(data2.t1,data2.Vsg,'o');
% %legend('If0','\alpha SAA','Ion current y intersect','average','standard deviation')
% set(gca, 'XTickMode', 'auto', 'XTickLabelMode', 'auto')
% datetick('x',20,'keepticks')
% grid on;
% axis([data1.t1(1) data1.t1(end) 0 10000])
% legend('ni\_v\_indep','ni\_v\_dep','asm\_ni\_v\_indep','ni\_v\_dep');
% title([sprintf('Density estimations probe 1 %s 19amu vion = 550m/s',shortphase)])

subplot(2,2,3)
plot(data1.t1,data1.ni_v_indep,'black',data1.t1,data1.ni_v_dep,'r',data1.t1,data1.asm_ni_v_indep,'bo')
%plot(data2.t1,data2.Vsg,'o');
%legend('If0','\alpha SAA','Ion current y intersect','average','standard deviation')
set(gca, 'XTickMode', 'auto', 'XTickLabelMode', 'auto')
datetick('x',20,'keepticks')
grid on;
axis([data1.t1(1) data1.t1(end) 0 10000])
legend('ni\_v\_indep','ni\_v\_dep','asm\_ni\_v\_indep');
title([sprintf('Density estimations probe 1 %s 19amu vion = 550m/s',shortphase)])
...
plot(meand1.t1,meand1.ni_v_dep,'b',meand1.t1,meand1.asm_ni_v_indep,'ro',meand1.t1,meand1.asm_ne_5eV,'black',meand1.t1,meand1.asm_ni_aion,'bo',meand1.t1,meand1.ne_exp,'black+');
...
datetick('x',20,'keepticks')
grid on;
legend('probe 1 ni\_v\_dep','probe 2 asm\_ni\_v\_indep','probe 1 asm\_ne\_5eV','probe 1 asm\_ni\_aion','probe 1 asm\_ne\_exp');
...
figure(1153)
plot(data1.t1,data1.ni_v_dep,'b',data1.t1,data1.asm_ni_v_indep,'ro',data1.t1,data1.asm_ne_5eV,'black',data1.t1,data1.asm_ni_aion,'bo',data1.t1,data1.ne_exp,'blacko');
...
plot(data1.t1,data1.Vph_knee,'blackdiamond',data1.t1,data1.Vsg,'rdiamond',data1.t1,data1.asm_Vsc_aion,'bo:',data1.t1,data1.Vsc_aion,'go:')
set(gca, 'XTickMode', 'auto', 'XTickLabelMode', 'auto')
datetick('x',20,'keepticks')
grid on;
legend('p1Vph\_knee','p1Vsg','p1asm\_Vsc\_aion','p1Vsc\_aion')
...
%plot(data1.t1,data1.Vsg,'blackdiamond',data1.t1,data1.Vph_knee,'rdiamond')
plot(data1.t1,data1.Vsg,'blackdiamond',data2.t1,data2.Vsg,'rdiamond',data1.t1,data1.Vsg,'bo',data2.t1,data2.Vsg,'go')
set(gca, 'XTickMode', 'auto', 'XTickLabelMode', 'auto')
datetick('x',20,'keepticks')
grid on;
legend('p1Vsg','p2Vsg','p1Vsg','p2asmVsg')

% 
% figure(70)
% plot(data1.t1,data1.asm_ni_v_indep,'ro',data1.t1,data1.ni_v_dep,'blacko',data2.t1,data2.ni_v_dep,'go',data2.t1,data2.asm_ni_v_indep,'bo')
% grid on;
% axis([data1.t1(1) data1.t1(end) 0 500])
% datetick('x',20)
% legend('probe1 asm\_ni\_v\_indep','probe1 ni\_v\_dep', 'probe2 asm\_ni\_v\_indep', 'probe2 ni\_v\_dep')
% 
...
%     
%     tv=data.asm_ni_v_indep(k) / (data.ni_v_dep(k) / 7000);
...
%plot(mediand1.t1,mediand1.v_ion,'bo',mediand2.t1,mediand2.v_ion,'ro',mediand1.t1,mediand1.v_aion,'blacko',mediand2.t1,mediand2.v_aion,'black+')
plot(mediand1.t1,mediand1.v_ion,'bo',mediand2.t1,mediand2.v_ion,'ro')
...
%legend('probe 1 v\_ion','probe 2 _v\_ion','probe 1 v\_aion','probe 2 v\_aion')
legend('probe 1 v\_ion','probe 2 _v\_ion')
...
%legend('probe 1 v\_ion','probe 2 v\_ion', 'probe 1 v\_aion')
...
subplot(2,1,2)
plot(data1.ni_v_dep,data1.asm_ni_v_indep,'ro',data2.ni_v_dep,data2.asm_ni_v_indep,'bo',[0 1000],[0 1000],'black')
legend('probe 1','probe 2','y=x')
title([strcat(sprintf('%s',shortphase),' ni\_v\_dep vs asm\_ni\_v\_indep')])
%axis([0 1000 0 1000])
grid on;
...
asm_vp1 = data1.Vph_knee(~isnan(data1.Vph_knee));
...
vp1 = data1.Vph_knee(~isnan(data1.Vph_knee));
...
for i=1:length(mediand1.t1)
    ...
    if  data1.Vph_knee(i,1) > 0
        
    asm_valpha(i) = abs(mediand1.Vph_knee(i,1)/mediand1.asm_Vsc_aion(i,1));
    else
            asm_valpha(i) = -abs(mediand1.Vph_knee(i,1)/mediand1.asm_Vsc_aion(i,1));
    ...
    valpha(i) = abs(mediand1.Vph_knee(i,1)/mediand1.Vsc_aion(i,1));
    else
            valpha(i) = -abs(mediand1.Vph_knee(i,1)/mediand1.Vsc_aion(i,1));
...
% legend('asm\_ni\_v\_indep','ni\_v\_dep','asm\_ne','asm\_ne\_5eV');
...
%plot(mediand2.t1,mediand2.Vsg,'o');
%legend('If0','\alpha SAA','Ion current y intersect','average','standard deviation')
set(gca, 'XTickMode', 'auto', 'XTickLabelMode', 'auto')
datetick('x',20,'keepticks')
grid on;
...
% 
% subplot(2,2,3)
% plot(mediand1.t1,mediand1.ni_v_indep,'blacko',mediand1.t1,mediand1.ni_v_dep,'ro',mediand1.t1,mediand1.asm_ni_v_indep,'bo',mediand1.t1,mediand1.ni_v_dep,'go')
% %plot(mediand2.t1,mediand2.Vsg,'o');
% %legend('If0','\alpha SAA','Ion current y intersect','average','standard deviation')
% set(gca, 'XTickMode', 'auto', 'XTickLabelMode', 'auto')
% datetick('x',20,'keepticks')
...
subplot(2,2,3)
plot(mediand1.t1,mediand1.ni_v_indep,'black',mediand1.t1,mediand1.ni_v_dep,'r',mediand1.t1,mediand1.asm_ni_v_indep,'bo',mediand1.t1,mediand1.ni_v_dep,'go')
%plot(mediand2.t1,mediand2.Vsg,'o');
%legend('If0','\alpha SAA','Ion current y intersect','average','standard deviation')
set(gca, 'XTickMode', 'auto', 'XTickLabelMode', 'auto')
datetick('x',20,'keepticks')
...
plot(mediand1.t1,mediand1.ni_v_dep,'b',mediand1.t1,mediand1.asm_ni_v_indep,'ro:',mediand1.t1,mediand1.asm_ne_5eV,'black',mediand1.t1,mediand1.asm_ni_aion,'bo:',mediand1.t1,mediand1.ne_exp,'black+:',mediand2.t1,mediand2.ni_v_dep,'b+:',mediand2.t1,mediand2.asm_ni_v_indep,'r+:',mediand2.t1,mediand2.asm_ni_aion,'bdiamond:');
...
datetick('x',20,'keepticks')
grid on;
legend('probe 1 ni\_v\_dep','probe 1 asm\_ni\_v\_indep','probe 1 asm\_ne\_5eV','probe 1 asm\_ni\_aion','probe 1 asm\_ne\_exp','probe 2 ni\_v\_dep','probe 2 asm\_ni\_v\_indep','probe 2 asm\_ni\_aion');
...
figure(2153)
plot(mediand1.t1,mediand1.ni_v_dep,'b',mediand1.t1,mediand1.asm_ni_v_indep,'ro',mediand1.t1,mediand1.asm_ne_5eV,'black',mediand1.t1,mediand1.asm_ni_aion,'bo',mediand1.t1,mediand1.ne_exp,'blacko');
...
plot(mediand1.t1,mediand1.Vph_knee,'blackdiamond',mediand1.t1,mediand1.Vsg,'rdiamond',mediand1.t1,mediand1.asm_Vsc_aion,'bo',mediand2.t1,mediand2.asm_Vsc_aion,'go')
set(gca, 'XTickMode', 'auto', 'XTickLabelMode', 'auto')
datetick('x',20,'keepticks')
grid on;
...
figure(253)
plot(mediand1.t1,mediand1.ni_v_dep,'blacko',mediand2.t1,mediand2.ni_v_dep,'black',mediand1.t1,mediand1.ne_5eV,'ro',mediand2.t1,mediand2.ne_5eV,'r',mediand1.t1,mediand1.ne_linear,'bo',mediand2.t1,mediand2.ne_linear,'b');
...
%plot(mediand1.t1,mediand1.Vsg,'blackdiamond',mediand1.t1,mediand1.Vph_knee,'rdiamond')
plot(mediand1.t1,mediand1.Vsg,'blackdiamond',mediand2.t1,mediand2.Vsg,'rdiamond',mediand1.t1,mediand1.Vsg,'bo',mediand2.t1,mediand2.Vsg,'go')
set(gca, 'XTickMode', 'auto', 'XTickLabelMode', 'auto')
datetick('x',20,'keepticks')
grid on;
legend('p1Vsg','p2Vsg','p1Vsg','p2asmVsg')
...
% 
% figure(70)
% plot(mediand1.t1,mediand1.asm_ni_v_indep,'ro',mediand1.t1,mediand1.ni_v_dep,'blacko',mediand2.t1,mediand2.ni_v_dep,'go',mediand2.t1,mediand2.asm_ni_v_indep,'bo')
% grid on;
...
subplot(2,1,2)
plot(mediand1.ni_v_dep,mediand1.asm_ni_v_indep,'ro',mediand2.ni_v_dep,mediand2.asm_ni_v_indep,'bo',[0 1000],[0 1000],'black')
legend('probe 1','probe 2','y=x')
title([strcat(sprintf('%s',shortphase),' ni\_v\_dep vs asm\_ni\_v\_indep')])
%axis([0 1000 0 1000])
grid on;
